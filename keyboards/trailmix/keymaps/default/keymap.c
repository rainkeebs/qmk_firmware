...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_RAISE] = LAYOUT(
		...
		KC_TAB, KC_CAPS, KC_DELETE, KC_BSLASH, KC_MINUS, KC_TRNS, KC_TRNS, KC_PLUS, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [_ADJUST] = LAYOUT(
		...
		KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_ENTER,
		KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MPLY, KC_PSCREEN, KC_N, KC_M, KC_COMM, KC_DOT, KC_BSPACE,
		KC_LCTRL, KC_LALT, ADJUST, RAISE, KC_SPC, KC_LSHIFT, LOWER, ADJUST, KC_RALT, KC_RCTRL
		),
};
